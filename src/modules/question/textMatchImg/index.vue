<template>
  <div :class="'homework-tiMatch-select ' + pagetype">
    <!--<div class="option">-->
      <!--【配对题】{{question.title}}-->
      <!--<div v-if="question.titleImgUrl" class="title-img" >-->
        <!--<img :src="question.titleImgUrl" alt="">-->
      <!--</div>-->
    <!--</div>-->
<!--    <div class="option titleImgInit" v-html="question.title"></div>-->
    <question-title :title="question.title" class="titleImgInit"></question-title>
    <Question :pagetype="pagetype" :question="question" answerType="studentAnswer"></Question>
...
<script lang="ts">
  ...
  export default class TextMatchImg extends Vue {
    @Prop({
      type: Object,
      default: ''
    })
